<main class="flex-1 p-6 overflow-y-auto">
    <div class="flex justify-between items-center bg-blue-900 text-white px-6 py-4 rounded-lg shadow mb-6">
        ...
        <div class="flex items-center space-x-4">
                    ...
                    <div class="flex px-4 py-3 hover:bg-gray-100 light:hover:bg-gray-700">
                        ...
                        <div class="w-full ps-3">
                            ...
                            <span class="text-gray-400 text-xs light:text-white">
                                Siti Aminah - Toilet belakang Gedung B rusak, kini sudah diperbaiki. Terima kasih.
                            </span>
                            <div class="text-xs text-blue-600 light:text-blue-500">16 Juli 2025, 08:10</div>
                        </div>
                    </div>
            ...
            <div class="relative">
                <button onclick="toggleDropdown()" class="p-1 rounded-full hover:ring-2 hover:ring-white transition">
                    <img src="image/admin.jpg" alt="Profil"
                ...
                <div id="dropdown-menu"
                    ...
                    <div class="flex flex-col items-center py-4 px-4">
                        ...
                        <p class="mt-2 font-semibold text-green-600">Siswa</p>
                    </div>

                    <hr class="border-gray-200" />

                    <a href="edit-profil.html" class="block px-4 py-2 hover:bg-blue-50 text-center">Edit
                        Profil</a>
