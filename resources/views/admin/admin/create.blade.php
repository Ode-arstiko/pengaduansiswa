<div class="w-full mx-auto bg-white shadow-md rounded-lg p-8 mt-10">
    <h1 class="text-2xl font-bold text-gray-700 mb-6">Tambah Data Admin</h1>

    <form action="/admin/kelola-admin/store" method="POST" enctype="multipart/form-data" class="space-y-6">
        @csrf
